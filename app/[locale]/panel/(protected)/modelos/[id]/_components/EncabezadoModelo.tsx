...
/**
 * Encabezado editable del modelo (nombre, descripción, precio, código de
 * solo lectura y estado de publicación). Es un componente controlado: el
 * guardado explícito de nombre/descripción/precio lo dispara el botón
 * "Guardar Cambios" del panel (ver ModeloConfigurador), no autosave, igual
 * que el _ModeloForm.tsx original.
 */
